...
# coding: utf-8
#
# This file adapted from https://raw.githubusercontent.com/jcrist/msgspec/refs/heads/main/examples/geojson/msgspec_geojson.py
# as part of the msgspec library examples.
#
# ``msgspec`` is a Python library for defining and serializing data structures, maintained
# by Jim Crist-Harif (@jcrist on GitHub), and licensed under the BSD 3-Clause License.
# See https://github.com/jcrist/msgspec/
#
